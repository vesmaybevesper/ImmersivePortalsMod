...
public class IntMatrix3 {
    ...
    public Direction transformDirection(Direction direction) {
        ...
        // There is a possibility of the camera snapping to north when facing down, but I don't actually know how likely that is, if its an issue I'll just remake fromDelta in a helper
        return Direction.getApproximateNearest(Vec3.atLowerCornerOf(vec));
    }
